...
%% Constants
k = 1.4;
R = 287;                %%% Assuming the same Altitude
Amax = 250;
M1 = 2;             
P1 = 12110;     % Pa
T1 = 216.5;     % K
...
IntakeArea = 1:50;
Thrust = 1:50;
BesttComustionTemp = 0;
%% Determining the intake angles
for theta = 1:0.05:30
    % from 1 to 2
    [M2,beta1,P2P1,T2T1] = OSW(M1,theta);
    
    % form 2 to 3
    for theta2 = 1:0.5:30
        [M3,beta2,P3P2,T3T2] = OSW(M2,theta2);
        if ~isreal(M3)
